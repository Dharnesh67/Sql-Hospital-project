		...
		<div class="row">
			<div class="d-flex flex-row justify-content-between ">
				<div class="col-4 p-3 d-flex flex-column align-items-center shadow rounded-half color">
					...
					<a href="Apply.php"><button class="btn bg-primary  text-white my-3">"Join Our Team"</button>
					</a>
				</div>
				<div class="col-4 p-3 d-flex flex-column align-items-center shadow rounded-half color">
					...
					<a href="acoount.php">
						<button class="btn bg-primary  text-white my-1 w-20">Create Account</button>
					</a>
				</div>
				<div class="col-3 p-3 d-flex flex-column align-items-center shadow rounded-half color">
					...
					<a href="more.php"><button class="btn bg-primary  mt-5 text-white">More</button>
					</a>
				</div>
			</div>
		</div>
